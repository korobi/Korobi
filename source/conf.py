# -*- coding: utf-8 -*-
#
# Korobi documentation build configuration file, created by
# sphinx-quickstart on Fri Jun 12 19:30:38 2015.
#
...
project = u'Korobi'
copyright = str(datetime.datetime.now().year) + u', Korobi Team'
